...
#'
#' @description This function reads GEDI level2B products: canopy cover, Plant Area Index (PAI),
#' Plant Area Volume Density (PAVD), and Foliage Height Diversity (FHD).
#'

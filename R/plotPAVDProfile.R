...
#'
#'@usage plotPAVDProfile<-function(level2BPAVDProfile, beam="BEAM0101", elev=TRUE)
#'
...
plotPAVDProfile<-function(level2BPAVDProfile, beam="BEAM0101", elev=TRUE){
  ...
  dft<-reshape2::melt(level2BPAVDProfile_sub[,c(2,6,8,9:38)], id.vars=c("shot_number","elev_lowestmode", "height_bin0"), variable.name="pavd", value.name="value")

...
#'
#' @usage gediWFMetrics(input,outRoot,inList,writeFit,writeGauss,readBinLVIS,readHDFlvis,readHDFgedi,
#'                      level2,bounds,beamList,skipBeams,readBeams,ground,useInt,useFrac,rhRes,laiRes,laiH,
#'                      noRHgauss,gTol,fhdHistRes,forcePsigma,bayesGround,dontTrustGround,noRoundCoord,noCanopy,
#'                      dcBias,nSig,seed,hNoise,linkNoise,linkFsig,linkPsig, trueSig,bitRate,maxDN,renoise,
#'                      newPsig,oldPsig,addDrift,missGround,minGap,photonCount,pcl,nPhotons,photonWind, noiseMult,
#'                      rhoVrhoG,nPhotC,nPhotG,photHDF,meanN,thresh,varNoise,varScale,statsLen,noiseTrack,sWidth,
#'                      psWidth, msWidth,preMatchF,postMatchF,pFile,gWidth,minGsig,minWidth,medNoise,varDrift,
#'                      driftFac,rhoG,rhoC,pSigma,gold,deconTol)
#'

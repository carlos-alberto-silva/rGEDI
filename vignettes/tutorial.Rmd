...
```{r, fig.width=7, fig.heiglht=3, echo=TRUE, eval=FALSE}
# View maps
library(rasterVis)
library(viridis)
...
```{r, fig.width=7, fig.heiglht=3, echo=FALSE, eval=TRUE}
...
```{r, fig.width=7, fig.height=3, eval = TRUE, echo = FALSE}
if (rasterVisLoaded) {
  levelplot(pai_metrics,
                   layout=c(4, 1),
                   margin=FALSE,
...
version 0.1.8, accessed on October. 22 2020, available at: <https://CRAN.R-project.org/package=rGEDI>

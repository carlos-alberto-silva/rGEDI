...
lasfile = fs::path_join(c(outdir, "Amazon.las"))
...
## ---- echo=FALSE, fig.width=500/90, fig.height=400/90--------------------
library(leaflet)
library(leafsync)
...
## ---- results="hide", fig.width=500/90, fig.height=360/90----------------
...
## ---- fig.width=400/90, fig.height=400/90, results = FALSE---------------
